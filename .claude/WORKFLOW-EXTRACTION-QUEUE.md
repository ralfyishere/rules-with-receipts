...
| WeCheck product strategy analysis | Roadmap/feature decisions | Generic product advice; misses domain constraints | 1-2 past decision memos | High | yes | Builds on product-thinking with WeCheck specifics |
...
| Prompt improvement | Any prompt edit request | Covered by prompt-engineering skill | — | Done | no | Already a skill; queue tracks only WeCheck-specific prompt conventions if they emerge |
...
| Competitive research | New competitor or fundraise prep | Coverage/recency inconsistent | 1 past competitive brief | Medium | maybe | research-methodology + a WeCheck source list may suffice |
